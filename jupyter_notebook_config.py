...
#  uses.
#  Default: {}
c.NotebookApp.tornado_settings = {"websocket_max_message_size": 2 * 1024 * 1024 * 1024}
...
#  Choices: any of ['sha256', 'sha3_512', 'sha224', 'sha1', 'sha512', 'sha3_384', 'blake2s', 'blake2b', 'sha3_224', 'md5', 'sha384', 'sha3_256']
#  Default: 'sha256'
